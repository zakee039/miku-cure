...
const translations = {
  ...
  zh: {
    ...
    'model.rnn.name':       'RNN + Attention（默认）',
    'model.rnn.desc':       '时序注意力模型，默认情绪识别引擎。',
  ...
  ja: {
    ...
    'model.rnn.name':       'RNN + Attention（デフォルト）',
    'model.rnn.desc':       '時系列 Attention モデル。標準の感情認識エンジン。',
  ...
  en: {
    ...
    'model.rnn.name':       'RNN + Attention (default)',
    'model.rnn.desc':       'Temporal attention model — the default emotion engine.',
